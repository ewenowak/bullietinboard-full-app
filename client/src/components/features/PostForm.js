  ...
  return (
    <div>
      <Form onSubmit={validate(onSubmit)}>
        ...
        <Form.Group className="mb-3">
          <Form.Label>Publication Date / Actualization Date</Form.Label>
          <DatePicker className="border border-1" date={publishedDate} format={'YYYY-MM-DD'} showBorder onChange={date => setPublishedDate(new Date(date))} placeholder={'Select date'} />
